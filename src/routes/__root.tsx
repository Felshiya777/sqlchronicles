...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "GHOSTLINE // learn SQL by hacking NEXACORP" },
      { property: "og:description", content: "Story-driven cyberpunk game that teaches SQL from beginner to advanced. Run real queries to take down the megacorp." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "GHOSTLINE // learn SQL by hacking NEXACORP" },
      { name: "twitter:description", content: "Story-driven cyberpunk game that teaches SQL from beginner to advanced. Run real queries to take down the megacorp." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2dea0e77-7665-41a0-88cb-33dfa1de3f8c/id-preview-d05e781c--95371438-22ba-44f6-b578-c9d93ca7334b.lovable.app-1780505629200.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2dea0e77-7665-41a0-88cb-33dfa1de3f8c/id-preview-d05e781c--95371438-22ba-44f6-b578-c9d93ca7334b.lovable.app-1780505629200.png" },
    ],
